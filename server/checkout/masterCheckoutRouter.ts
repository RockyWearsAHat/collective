...
masterCheckoutRouter.use("/writeCheckoutSecretToUser", writeCheckoutSecretToUserRouter);
masterCheckoutRouter.use("/getCheckoutSecretFromUser", getCheckoutSecretFromUserRouter);
